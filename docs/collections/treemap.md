...
之前 [LinkedHashMap](https://mp.weixin.qq.com/s/yI6mMIjddKnAOjOfwzjlXw) 那篇文章里提到过了，HashMap 是无序的，所有有了 LinkedHashMap，加上了双向链表后，就可以保持元素的插入顺序和访问顺序，那 TreeMap 呢？
...
在学习 TreeMap 之前，我们已经学习了 [HashMap](https://mp.weixin.qq.com/s/VLf3bNKB_s2CImsVItxuRw) 和 [LinkedHashMap](https://mp.weixin.qq.com/s/yI6mMIjddKnAOjOfwzjlXw) ，那如何从它们三个中间选择呢？
